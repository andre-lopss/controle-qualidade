...
,	CONSTRAINT CD_TIPO_PRODUTO FOREIGN KEY(CD_TIPO_PRODUTO)	
    REFERENCES PRODUCAO.TIPO_PRODUTO (CD_TIPO_PRODUTO)
    ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
,	CONSTRAINT CD_SETOR FOREIGN KEY(CD_SETOR) 
	REFERENCES PRODUCAO.SETOR (CD_SETOR)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
,	CONSTRAINT CD_MATRICULA_INSPETOR FOREIGN KEY(CD_MATRICULA_INSPETOR)
	REFERENCES PRODUCAO.INSPETOR(CD_MATRICULA_INSPETOR)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
,	CONSTRAINT CD_PRODUTO FOREIGN KEY(CD_PRODUTO)
	REFERENCES PRODUCAO.PRODUTO(CD_PRODUTO)
	ON DELETE CASCADE
	ON UPDATE CASCADE     
,	CONSTRAINT CD_FICHA_AVALIACAO FOREIGN KEY(CD_FICHA_AVALIACAO)
	REFERENCES PRODUCAO.FICHA_AVALIACAO(CD_FICHA_AVALIACAO)
	ON DELETE CASCADE
	ON UPDATE CASCADE
,	CONSTRAINT SG_AVALIACAO FOREIGN KEY(SG_AVALIACAO)				
	REFERENCES PRODUCAO.AVALIACAO (SG_AVALIACAO)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
VALUES  (1, 'André'), (1, 'Maria'), (1, 'Julia'), (1, 'Vera'), (1, 'Mara')
,		(1, 'Fernanda'),(1, 'Trancoso'), (1, 'Helena'), (1, 'Paula'), (1, 'Victoria')
COMMIT;
